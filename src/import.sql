...
INSERT INTO Activity (closed, date, deprecated, location, restriction, text, title, version, owner_id, state_id, subcategory_id) VALUES (0, "2016-06-25 16:00:00", 0, 'Wien', 4, 'Würde wer mitfahren Donauinselfest?', 'Donauinselfest', 0, 4, 9, 18);

INSERT INTO Activity (closed, date, deprecated, location, restriction, text, title, version, owner_id, state_id, subcategory_id) VALUES (0, "2016-06-30 08:11:00", 0, 'Bregenz', 3, 'Integralrechnen nochmal durchgehen', 'Lernen für zweite Schularbeit', 0, 2, 8, 11);
INSERT INTO Activity (closed, date, deprecated, location, restriction, text, title, version, owner_id, state_id, subcategory_id) VALUES (0, "2016-07-01 11:01:00", 0, 'Innsbruck', 3, 'Deutsch lernen für Prüfung', 'NeinNeinNein!', 0, 5, 7, 16);
