...
<body>
	<div id="wrapper">
		...
		<div class="container-fluid">
			...
			<div class="col-lg-8">
				<form class="form-horizontal" method="post" action="editActivity">
					<input type="hidden" name="${_csrf.parameterName}"
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input class="form_datetime" id="date"
									type="text"
									value="<fmt:formatDate value="${activity.date}" pattern="dd.MM.yyyy"/>"
									name="date">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea rows="4" class="form-control" id="text"
									 name="text">${activity.text} </textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input class="form-control" id="restriction" type="text"
